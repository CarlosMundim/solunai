...
export default function AssistPageEN() {
  const assistants = [
    {
      title: 'Secretary Bot',
      description: 'Meeting transcription, schedule management, note-taking, follow-up reminders. Handles administrative tasks efficiently.',
      features: ['Meeting transcription', 'Schedule coordination', 'Note summarization', 'Task reminders']
    },
    {
      title: 'Analyst Bot',
      description: 'Document analysis, data extraction, report generation. Transform unstructured information into actionable insights.',
      features: ['Document analysis', 'Data extraction', 'Report generation', 'Trend analysis']
    },
    {
      title: 'Support Bot',
      description: 'Customer service with Japanese language and cultural awareness. Handle inquiries with appropriate formality.',
      features: ['Japanese-aware responses', 'FAQ handling', 'Ticket routing', 'Escalation management']
    },
    {
      title: 'HR Bot',
      description: 'Employee onboarding, policy inquiries, leave management. Streamline HR operations while maintaining privacy.',
      features: ['Onboarding support', 'Policy Q&A', 'Leave processing', 'Document collection']
    }
  ];
      ...
      <section className="bg-white">
        <div className="mx-auto max-w-5xl px-6 py-16 md:px-8 md:py-20">
          ...
          <p className="mt-6 max-w-3xl text-base leading-relaxed text-neutral-700 md:text-lg" style={{ lineHeight: '1.8' }}>
            Purpose-built AI assistants for specific business functions. Secretary tasks, analysis work, customer support - all designed with Japanese business practices in mind.
          </p>
        ...
        <div className="mx-auto max-w-5xl px-6 md:px-8">
          ...
          <div className="mt-8 grid gap-6 md:grid-cols-3">
            <div className="rounded-2xl border border-neutral-200 bg-white p-6 shadow-sm transition-all hover:border-sky-200 hover:shadow-md">
              ...
              <h4 className="mt-4 font-semibold text-neutral-900" style={{ lineHeight: '1.5' }}>Requirements Analysis</h4>
              <p className="mt-2 text-sm text-neutral-600" style={{ lineHeight: '1.8' }}>
                We understand your business processes and identify where AI assistance provides the most value.
              </p>
            </div>
            <div className="rounded-2xl border border-neutral-200 bg-white p-6 shadow-sm transition-all hover:border-sky-200 hover:shadow-md">
              <div className="flex h-8 w-8 items-center justify-center rounded-full bg-sky-100 text-sm font-semibold text-sky-700">2</div>
              <h4 className="mt-4 font-semibold text-neutral-900" style={{ lineHeight: '1.5' }}>Custom Development</h4>
              <p className="mt-2 text-sm text-neutral-600" style={{ lineHeight: '1.8' }}>
                Build and train your assistant with your data, terminology, and business rules.
              </p>
            </div>
            <div className="rounded-2xl border border-neutral-200 bg-white p-6 shadow-sm transition-all hover:border-sky-200 hover:shadow-md">
              <div className="flex h-8 w-8 items-center justify-center rounded-full bg-sky-100 text-sm font-semibold text-sky-700">3</div>
              <h4 className="mt-4 font-semibold text-neutral-900" style={{ lineHeight: '1.5' }}>Deploy & Optimize</h4>
              <p className="mt-2 text-sm text-neutral-600" style={{ lineHeight: '1.8' }}>
                Integration with your systems followed by continuous improvement based on usage.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="bg-gradient-to-br from-sky-700 to-sky-900 py-16 md:py-20">
        <div className="mx-auto max-w-3xl px-6 text-center md:px-8">
          <h2 className="text-2xl font-bold text-white md:text-3xl" style={{ lineHeight: '1.4' }}>
            Build Your Custom AI Worker
          </h2>
          <p className="mt-4 text-base leading-relaxed text-sky-100 md:text-lg" style={{ lineHeight: '1.8' }}>
            Tell us about your workflow and we will design an AI assistant that fits your needs.
          </p>
