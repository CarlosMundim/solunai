// Component inclusion system for shared header and footer (English pages)
...
document.addEventListener('DOMContentLoaded', async function() {
    ...
    await Promise.all([
        loadComponent('header-placeholder', '../components/header-en.html'),
        loadComponent('footer-placeholder', '../components/footer-en.html')
    ]);
